...
private:
    ...
    bool mTransport = false; ///<whether transporters should be on
    bool mShowHistory = false; ///<whether mouse history should be on
public:
    ...
    afx_msg void OnTransporterAddtransporter();
    afx_msg void OnUpdateTransporterTransport(CCmdUI* pCmdUI);
    afx_msg void OnTransporterTransport();
